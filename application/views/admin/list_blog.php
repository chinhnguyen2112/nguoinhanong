                    ...
                    <div class="card-body">
                        <div class="box_search_forrm">
                            ...
                            <select name="" id="cate">
                                ...
                                <option <?= ($this->input->get('cate') == $val['id']) ? 'selected' : '' ?>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a href="/add_blog?id=<?= $val['id']; ?>" target="_blank">
                                                    <button style="font-size: 16px;" class="btn btn-xs btn-default"
                                                        type="button" data-toggle="tooltip" title="Sửa tài khoản"><i
