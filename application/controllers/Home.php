...
class Home extends CI_Controller
{
    ...
    public function home()
    {
        ...
        // list cate 1
        $name_cate_1 = $this->Madmin->query_sql_row("SELECT category.name as cate_name_1, category.alias as cate_alias_1 FROM blogs INNER JOIN category WHERE category.id = blogs.chuyenmuc AND blogs.type = 0");
        ...
        // list cate 2
        $name_cate_2 = $this->Madmin->query_sql_row("SELECT category.name as cate_name_2, category.alias as cate_alias_2 FROM blogs INNER JOIN category WHERE category.id = blogs.chuyenmuc AND blogs.type = 0");
