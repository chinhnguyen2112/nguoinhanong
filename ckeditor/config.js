				...
				a: function (element) {
					if (!element.attributes.rel) {
						...
						if (
							...
							hostname !== "https://nguoinhanong.vn/"
						) {
	...
	CKEDITOR.editorConfig = function (config) {
        ...
        ***/
		...
		(config.filebrowserBrowseUrl =
			"https://nguoinhanong.vn/ckeditor/ckfinder/ckfinder.php"),
			(config.filebrowserUploadUrl =
				"https://nguoinhanong.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files"),
			(config.filebrowserImageUploadUrl =
				"https://nguoinhanong.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images"),
			(config.filebrowserFlashUploadUrl =
				"https://nguoinhanong.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash"),
			// My Plugin
			/*/		
            config.plugins =
            // Plugin
